...
#this function will need to be ran to calibrate the target positons of the clicks
def calibrate():
    variables = []
    weight = 5
    ...
    tab_presses(5)
    autogui.press('enter')
    popupmsg("hover over lazy activity level" )
    time.sleep(2)
    variables.append(autogui.position())
    popupmsg("hover over normal activity level" )
    time.sleep(2)
    variables.append(autogui.position())
    popupmsg("hover over very active activity level" )
    time.sleep(2)
    variables.append(autogui.position())
